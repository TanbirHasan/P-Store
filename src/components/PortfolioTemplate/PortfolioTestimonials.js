	...
	return (
		<div className="lg:w-[90%] mx-auto p-10">
			...
			<Swiper
				...
				className="mySwiper1 w-2/4 mx-auto my-10">
				{userTestimonialInfo.map((testimonial) => (
					<SwiperSlide key={testimonial._id} className="bg-white cursor-grab ">
								...
								<figure className="relative z-10">
									...
									<figcaption className="flex items-center gap-4 p-6 pt-2 text-sm text-emerald-500">
										<div className="flex flex-col gap-1">
											<span className="font-bold uppercase">{testimonial.recommenderName}</span>
											<cite className="not-italic">
												<p>{testimonial.recommenderDesignation}</p>
											</cite>
										</div>
									</figcaption>
								</figure>
