			...
			<ul
				...
				{userExperience?.map((exp) => (
					<li
						key={exp._id}
						role="article"
						className="relative pl-6 before:absolute before:left-0 before:top-2 before:z-10 before:h-2 before:w-2 before:-translate-x-1/2 before:rounded-full before:bg-blue-500 before:ring-2 before:ring-white">
						<div className="flex flex-col flex-1">
							<h4 className="text-lg font-medium text-blue-700 m-0">{exp.position} </h4>
