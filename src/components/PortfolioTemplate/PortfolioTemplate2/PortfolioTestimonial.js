...
const PortfolioTestimonial = () => {
	...
	return (
		<div className="my-14">
			...
			<div className="mt-12">
				<ul className="grid items-center gap-6 sm:grid-cols-2  max-w-7xl mx-auto px-10">
					{userTestimonialInfo.map((item, idx) => (
						<li key={idx} className="bg-white rounded-xl border shadow-md my-10 w-full ">
							<div className="p-4">
								<svg
