...
const AddRecommendation = ({ setShowAddRecommendation }) => {
	const {
		register,
		handleSubmit,
		formState: { errors },
    ...
    const handleAddRecommenderInformation = (data) => {
	...
	return (
		<div>
			...
			<form onSubmit={handleSubmit(handleAddRecommenderInformation)}>
				<div className="mb-5">
